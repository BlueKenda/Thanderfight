...
$(function(){
	...
	playerAnimation["idle"]		= new $.gQ.Animation({imageURL: "images/player_spaceship.png"});
	playerAnimation["explode"]	= new $.gQ.Animation({imageURL: "images/player_explode.png", numberOfFrame: 4, delta: 26, rate: 60, type: $.gQ.ANIMATION_VERTICAL});
	playerAnimation["up"]		= new $.gQ.Animation({imageURL: "images/boosterup.png", numberOfFrame: 6, delta: 14, rate: 60, type: $.gQ.ANIMATION_HORIZONTAL});
	playerAnimation["down"]		= new $.gQ.Animation({imageURL: "images/boosterdown.png", numberOfFrame: 6, delta: 14, rate: 60, type: $.gQ.ANIMATION_HORIZONTAL});
	playerAnimation["boost"]	= new $.gQ.Animation({imageURL: "images/booster1.png" , numberOfFrame: 6, delta: 14, rate: 60, type: $.gQ.ANIMATION_VERTICAL});
	playerAnimation["booster"]	= new $.gQ.Animation({imageURL: "images/booster2.png", numberOfFrame: 6, delta: 14, rate: 60, type: $.gQ.ANIMATION_VERTICAL});
	
	//  List of enemies animations :
	// 1st kind of enemy:
	enemies[0] = new Array(); // enemies have two animations
	enemies[0]["idle"]	= new $.gQ.Animation({imageURL: "images/minion_idle.png", numberOfFrame: 5, delta: 52, rate: 60, type: $.gQ.ANIMATION_VERTICAL});
	enemies[0]["explode"]	= new $.gQ.Animation({imageURL: "images/minion_explode.png", numberOfFrame: 11, delta: 52, rate: 30, type: $.gQ.ANIMATION_VERTICAL | $.gQ.ANIMATION_CALLBACK});
	
	// 2nd kind of enemy:
	enemies[1] = new Array();
	enemies[1]["idle"]	= new $.gQ.Animation({imageURL: "images/brainy_idle.png", numberOfFrame: 8, delta: 42, rate: 60, type: $.gQ.ANIMATION_VERTICAL});
	enemies[1]["explode"]	= new $.gQ.Animation({imageURL: "images/brainy_explode.png", numberOfFrame: 8, delta: 42, rate: 60, type: $.gQ.ANIMATION_VERTICAL | $.gQ.ANIMATION_CALLBACK});
	
	// 3rd kind of enemy:
	enemies[2] = new Array();
	enemies[2]["idle"]	= new $.gQ.Animation({imageURL: "images/bossy_idle.png", numberOfFrame: 5, delta: 100, rate: 60, type: $.gQ.ANIMATION_VERTICAL});
	enemies[2]["explode"]	= new $.gQ.Animation({imageURL: "images/bossy_explode.png", numberOfFrame: 9, delta: 100, rate: 60, type: $.gQ.ANIMATION_VERTICAL | $.gQ.ANIMATION_CALLBACK});
	
	// Weapon missile:
	missile["player"] = new $.gQ.Animation({imageURL: "images/player_missile.png", numberOfFrame: 6, delta: 10, rate: 90, type: $.gQ.ANIMATION_VERTICAL});
	missile["enemies"] = new $.gQ.Animation({imageURL: "images/enemy_missile.png", numberOfFrame: 6, delta: 15, rate: 90, type: $.gQ.ANIMATION_VERTICAL});
	missile["playerexplode"] = new $.gQ.Animation({imageURL: "images/player_missile_explode.png" , numberOfFrame: 8, delta: 23, rate: 90, type: $.gQ.ANIMATION_VERTICAL | $.gQ.ANIMATION_CALLBACK});
	missile["enemiesexplode"] = new $.gQ.Animation({imageURL: "images/enemy_missile_explode.png" , numberOfFrame: 6, delta: 15, rate: 90, type: $.gQ.ANIMATION_VERTICAL | $.gQ.ANIMATION_CALLBACK});
